...
- 실제 회차 데이터셋(`../datasets/info-sec-engineer-practical-past-exams/01-rounds/`)을 참조하는 문항은 `기출 기반 · 복원 문항`으로 표시한다. 이는 공식 원문을 보장한다는 뜻이 아니며, `source-derived` 상태를 함께 확인해야 한다.
