---
title: "Architecture: 기출 복원 보기·코드 블록 렌더링"
tier: llm-synthesis
page_type: method
...
source_paths:
  ...
  - "wiki/domains/information-security/practice/docs/past-exam-import-architecture.md"
  - "wiki/domains/information-security/practice/styles/components.css"
source_count: 4
provenance: inferred
summary: "기출 복원 지문에서 코드·명령·설정·패킷 흐름 보기를 안전하고 일관되게 블록으로 표시하는 최소 확장 설계와 구현 계약."
evergreen: false
---
