...
| includes answer/scoring key | pass |
| includes basis and confidence | pass |
| official exam guarantee avoided | pass |
...
| 위험관리/위험평가 | 1, 2, 3 |
| 접근통제/권한관리 | 4, 5, 16, 27 |
| 리눅스/유닉스 로그·명령 | 6, 7, 8, 9, 27, 34 |
| 웹 취약점/시큐어코딩 | 10, 11, 12, 23, 24, 31, 32 |
| DNS/SNMP/VLAN/네트워크장비 | 14, 20, 28, 33 |
| IPSec/VPN/암호통신 | 13 |
| 개인정보/ISMS-P/법규 | 16, 26 |
| 관제/탐지/포렌식 | 17, 21, 29 |
| 업무연속성/재해복구 | 25 |
| DB/데이터보호 | 18, 30, 35 |
| 무선/모바일/최근 확장 | 36 |
