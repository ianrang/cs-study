...
|---:|---|---|---|---|
| 1 | short | 다음에서 설명하는 Windows 암호화 기능의 명칭을 쓰시오. | BitLocker | source-derived from Information Security Tistory; answer block present |
...
| 5 | short | 다음에서 설명하는 HTTP 관련 공격의 명칭을 쓰시오. | Slow HTTP Header DoS(Slowloris) | source-derived from Information Security Tistory; answer block present |
...
| 10 | short | 다음에서 설명하는 공격의 명칭을 쓰시오. | 공급망 공격(Supply Chain Attack) | source-derived from Information Security Tistory; answer block present |
