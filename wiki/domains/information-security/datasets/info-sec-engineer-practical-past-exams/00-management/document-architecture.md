...
| 레이어 | 역할 | 문서 | 책임 |
|---|---|---|---|
| Management | 문서 운영 규칙 | `document-architecture.md`, `document-management-scaffold.md`, `document-physical-migration-plan.md`, `analysis-roadmap-todo.md` | SSOT, 응집도, 진입점, 변경 절차, 물리 이동 계획, 작업 상태를 관리한다. 분석 본문을 넣지 않는다. |
