...
| R23-Q16 | 23회 | 16 | 서비스 보안설정 점검과 보완 | REF-KCA-INFOSEC-PRACTICAL-CRITERIA | Cache-Control 헤더는 DDoS/캐시 운용 상황에서 HTTP 캐시 동작을 제어한다. | medium | 웹 서비스 설정 연결, 세부 원천 보강 가능 |
...
| R24-Q4 | 24회 | 4 | 프로토콜별 보안특성 파악 | REF-KCA-INFOSEC-PRACTICAL-CRITERIA | 무선랜 보안 표준은 무선 프로토콜 보안특성이다. | medium | 잔여 분류 finding 대상, 보수적 유지 |
...
| R24-Q8 | 24회 | 8 | 정보수집 및 모니터링 | REF-KCA-INFOSEC-PRACTICAL-CRITERIA | DLP는 내부정보 유출 탐지·통제 솔루션이다. | medium | 잔여 분류 finding 대상, 관제/자산보호 양쪽 연결 |
...
| R25-Q2 | 25회 | 2 | IT 자산 위협 분석 | REF-KCA-INFOSEC-PRACTICAL-CRITERIA | TEMPEST는 전자파 방사 정보 유출 위협이다. | medium | 전문 위협 원천 보강 가능 |
...
| R25-Q12 | 25회 | 12 | 정보수집 및 모니터링 | REF-KCA-INFOSEC-PRACTICAL-CRITERIA | SOAR는 보안관제 자동화·대응 오케스트레이션 체계다. | medium | 제품/운영 개념 원천 보강 가능 |
...
| R25-Q18 | 25회 | 18 | 로그분석 및 대응 | REF-KCA-INFOSEC-PRACTICAL-CRITERIA | PE 악성코드 분석은 정적·동적 분석으로 침해 원인을 파악하는 주제다. | medium | 악성코드 분석 세부 원천 보강 가능 |
...
| R27-Q4 | 27회 | 4 | IT 자산 위협 분석 | REF-KCA-INFOSEC-PRACTICAL-CRITERIA | CISO 지정과 전자금융거래법상 책임은 정보보호 법적 준거성 판단이다. | medium | 최신 법령 확인 필요 |
...
| R27-Q16 | 27회 | 16 | IT 자산 위협 분석 | REF-KCA-INFOSEC-PRACTICAL-CRITERIA | DR site 유형은 업무연속성과 자산 보호대책 선정 주제다. | medium | 재해복구 세부 원천 보강 가능 |
