...
| R24-Q1 | 24회 | 1 | 위험평가 | REF-KCA-INFOSEC-PRACTICAL-CRITERIA; REF-PIPC-PIA-GUIDE | 개인정보영향평가 수행 안내서의 공식은 `자산 가치(영향도) + (침해요인 발생가능성 * 법적 준거성) * 2`로 확인된다. | high | `(C)`는 조직의 위험 수용 수준이 아니라 공식에 곱해지는 상수 `2` |
